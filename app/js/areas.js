export function areas(){
    ...
    const addOfficeFormContainer = document.getElementById('addOfficeFormContainer')
    const editOfficeFormContainer = document.getElementById('editOfficeFormContainer')
