export function pedidoToner() {
    ...
    async function realizarPedido() {
        ...
        const entrega = []
        entrega.push({"AREA":selectedAreaName,"TONER":selectedTonerName,"Cantidad":cantidad})
        console.log(entrega);
        await mensajeEntrega(`Se entrego un ${selectedTonerName} para ${selectedAreaName}`)
